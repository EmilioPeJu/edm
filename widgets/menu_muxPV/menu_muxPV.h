...
#define MMUX_MAX_STRING_SIZE 66

#define MMUXC_K_COLOURMODE_STATIC 0
#define MMUXC_K_COLOURMODE_ALARM 1
...
class menuMuxPVClass : public activeGraphicClass {
...
friend void mmux_expansionUpdate (
  ProcessVariable *pv,
  void *userarg );
...
friend void mmux_monitor_expansion_connect_state (
  ProcessVariable *pv,
  void *userarg );
...
// edit buffer
  ...
  int bufW;
  int bufH;
  int bufTopShadowColour;
  int bufBotShadowColour;
  int bufFgColour;
  int bufBgColour;
  int bufFgColourMode;
  int bufBgColourMode;
...
int topShadowColour;
int botShadowColour;
pvColorClass fgColour, bgColour;
int fgColourMode, bgColourMode;
...
void *clone_menuMuxPVClassPtr ( void * );
