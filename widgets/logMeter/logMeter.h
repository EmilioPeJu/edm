...
#include "logMeter.str"

static char *dragName[] = {
  activeLogMeterClass_str1
};
...
class activeLogMeterClass : public activeGraphicClass {
...
friend void logMeterc_edit_ok (
  Widget w,
  XtPointer client,
  XtPointer call );

friend void logMeterc_edit_update (
  Widget w,
  XtPointer client,
  XtPointer call );

friend void logMeterc_edit_apply (
  Widget w,
  XtPointer client,
  XtPointer call );

friend void logMeterc_edit_cancel (
  Widget w,
  XtPointer client,
  XtPointer call );

friend void logMeterc_edit_cancel_delete (
  Widget w,
  XtPointer client,
  XtPointer call );

friend void logMeter_readUpdate (
  ProcessVariable *pv,
  void *userarg );

friend void logMeter_monitor_read_connect_state (
  ProcessVariable *pv,
  void *userarg );
...
void *clone_activeLogMeterClassPtr ( void * );
